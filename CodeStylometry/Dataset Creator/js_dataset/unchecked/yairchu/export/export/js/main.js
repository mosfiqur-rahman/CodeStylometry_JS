...
var _2e_2e1 = function (local_10) {
           var x = _3e_3d({infixl: local_10.start1,infixr: local_10.stop1});
           switch (x.tag)
           {
             case "False":
               var local_11 = x.data;
               return {tag: "NonEmpty"
                      ,data: {head: local_10.start1
                             ,tail: function (local_12) {
                                return _2e_2e1({step: local_10.step
                                               ,start1: _2b({infixl: local_10.start1
                                                            ,infixr: local_10.step})
                                               ,stop1: local_10.stop1});
                             }}};
             case "True":
               var local_13 = x.data;
               return {tag: "Empty",data: {}};
...
var _2e_2e = function (local_9) {
           return _2e_2e1({step: 1.0,start1: local_9.start,stop1: local_9.stop});
        };
...
var fromArray = function (array) {
           ...
           return map({mapping: function (local_8) {
                      ...
                      ,stream: _2e_2e({stop: len,start: 0.0})});
        };
...
var reverse = function (src) {
           ...
           return map({mapping: function (i) {
                      ...
                      ,stream: _2e_2e({stop: len1,start: 0.0})});
        };
...
var id = function (_5f_5fx) { return _5f_5fx;};
var while = function (local_41) {
           var x = local_41.iter(local_41.init);
           switch (x.tag)
           {
             case "Continue":
               var local_42 = x.data;
               return while({iter: local_41.iter,init: local_42});
             case "Done":
               return id(x.data);
             default:
               throw "Unhandled case? This is a type error!";
...
var asciiDigit = function (_5f_5fx1) {
           var r1 = _2d({infixl: _5f_5fx1,infixr: 48.0});
...
var fromBytes = function (bytes) {
           ...
           return map({mapping: function (local_60) {
                      ...
                      ,stream: _2e_2e({stop: len2,start: 0.0})});
        };
...
var split = function (local_89) {
           ...
           switch (x.tag)
           {
             case "Just":
               var sepIndex = x.data;
               return {tag: "NonEmpty"
                      ,data: {head: slice({object: bytes1,start2: 0.0,stop2: sepIndex})
                             ,tail: function (local_98) {
                                return split({text2: slice({object: bytes1
                                                           ,start2: _2b({infixl: sepIndex
                                                                        ,infixr: sepLen})
                                                           ,stop2: length1(bytes1)})
...
var codeJamParse = function (local_88) {
           ...
           return while({iter: function (local_103) {
...
rts.logRepl(codeJam({func: function (local_1) {
                       return mapResult({mapping1: function (input) {
                                           ...
                                           switch (x.tag)
                                           {
                                             case "False":
                                               var local_2 = x.data;
                                               return while({iter: function (local_3) {
                                                               var numDigs =
